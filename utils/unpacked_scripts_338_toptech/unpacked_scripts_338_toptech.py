...
BIN_FOR_UNPACK = 'messi_unpack.bin'
...
def load_header_file_store_to_mmc_info(header_file_name):
    ...
    for line in fread:
        ...
        if 'setenv' in line or 'saveenv' in line or 'printenv' in line:
            print 'nguyen \t' + line
        ...
        if (env_name == 'nothing'):
            ...
            if 'FirmwareFileName=' in line:
                if bool_modify_firmware_filename == 0:
                    ...
                    fwrite.write(line)
            elif 'Suffix' in line and first_time == 1:
                fwrite.write(line)
                print 'setenv'
                first_time = 0
                for env in list_env:
                    print 'env' + env
                    fwrite.write(env)
            elif 'setenv' in line or 'saveenv' in line or 'printenv' in line:
                pass
            else:
                fwrite.write(line)
        else:
